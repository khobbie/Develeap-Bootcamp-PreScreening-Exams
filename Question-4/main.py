...
# Loop over lines
  for sentence in f:
    ...
    if begin == True and end == True:
        ...
        # print("diff_in_milli_secs: " + str(diff_in_milli_secs))
        # print("timeDifference: " + str(timeDifference))
     
        # Update the fastest timedifference if greater
        if float(diff_in_milli_secs) > float(timeDifference):
            timeDifference = diff_in_milli_secs
...
# Displaying Results
print('\n\n')
print("final: " + str(timeDifference))
print("ID: " + str(id))
